...
<div class="redemption-banner">
    <video autoplay muted loop>
        <source src="video/eternity.mp4" type="video/mp4 ">
    </video>
</div>

<div class="redemption-1">
    <h2>Kejutan Poin Trading Eternity Total Berhadiah Puluhan Juta</h2>
    <div class="redemption-1-content">
        <h4>Cuma Modal Trading Bisa Dapet Hadiah Puluhan Juta?</h4>
        <p>Caranya mudah, tiap trading di Eternity kamu dapat poin. Kumpulkan poin
            sebanyak-banyaknya untuk ditukarkan dengan beragam hadiah hingga puluhan
            juta Rupiah, mulai dari STAYCATION, GADGET, ELECTRONICS sampai
            LIFESTYLE bisa kamu dapatkan.
            Program Kejutan Poin ini berlaku untuk setiap transaksi pada Akun Standard,
            Akun Executive, dan Akun Ultimate.</p>
    </div>
            <div class="goldTable" style="margin:2vw 0;">
        <div class="goldTableContent">
            <table>
            <tr>
                <th class="thCommo1">Jenis Akun</th>
                <th>STANDARD</th>
                <th>EXECUTIVE</td>
                <th class="thCommo2">ULTIMATE</th>
            </tr>
            <tr>
                <td class="thCommo3">Poin yang didapat per Tranksaksi 1 Lot one way</td>
                <td>1 POIN</td>
                <td>2 POIN</td>
                <td class="thCommo4">3 POIN</td>
            </tr>
            </table>
            </div>
        </div>
    <div class="redemption-promo">
        <b>Tunggu Apa Lagi?</b>
        <p>Semakin Banyak Lot Kamu Trading, </p>
        <p>Maka Semakin Banyak Pula Kesempatan Hadiah Menarik Untuk di Redeem</p>
